...
git clone https://github.com/AlexisTrouve/confluent.git
cd confluent
...
```
confluent/
├── ancien-confluent/               # Ancient Confluent variant
│   ├── docs/                       # Linguistic reference
...
│   └── lexique/                    # Lexicon data by category
├── proto-confluent/                # Proto-Confluent variant
│   ├── docs/                       # Proto-Confluent documentation
│   └── lexique/                    # Proto lexicon data
...
1. [Phonology](ancien-confluent/docs/01-PHONOLOGIE.md) - Sounds and phonetic rules
2. [Morphology](ancien-confluent/docs/02-MORPHOLOGIE.md) - Word structure and liaisons
3. [Grammar](ancien-confluent/docs/03-GRAMMAIRE.md) - Verbs and conjugations
4. [Syntax](ancien-confluent/docs/04-SYNTAXE.md) - Sentence construction
5. [Vocabulary](ancien-confluent/docs/05-VOCABULAIRE.md) - Complete lexicon
