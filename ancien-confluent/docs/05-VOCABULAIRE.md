# Vocabulaire validé du Confluent

Ce document recense tout le vocabulaire validé et prêt à l'usage.
...
| **iko** | un, unique, seul | Concept fondateur |
| **ita** | être, exister | Existence |
| **ena** | origine, source, naissance | Dimension |
| **eka** | tout, entier, totalité | Dimension |
| **oki** | épreuve, défi, danger | Conflit sacré |
| **ora** | aurore, aube | Moment sacré |
| **onu** | son, vibration | Rituel |

### Les 52 racines standards (consonne initiale)
...
| Racine | Sens |
|--------|------|
| **kota** | union, confluence, ensemble |
| **naki** | enfant, descendant |
| **tori** | personne, individu |
| **vaku** | ami, allié |
| **zoka** | ennemi, étranger hostile |
| **mitu** | famille, clan |
| **kasi** | chef, guide |
...
*Voir aussi : data/lexique.json pour la version structurée*
