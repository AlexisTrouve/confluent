# Contexte culturel de la Civilisation de la Confluence

Ce document présente le contexte culturel nécessaire pour comprendre la langue Confluent.
...
| **Passes-bien** (Takitosa) | Marchands, médiateurs | Caste mixte |

### Système politique

- **Oligarchie consociationnelle** des Cinq Castes (Air, Feu, Eau, Terre, Éther)
- **Arbitre des Esprits** : Entité tutélaire/divine, pouvoir de réserve
...
- **Les Premiers Ancêtres** : Civilisation disparue découverte sous le Gouffre Humide, technologiquement supérieure, mystérieusement éteinte
- **Anxiété existentielle** : "Promis à pareil destin" - mission de ne pas répéter leurs erreurs
- Le **ciel** et les **aurores** comme signes divins
...
## Les artefacts multi-générationnels
...
|----------|-------------|
| **La Grande Fresque** | Couches de peinture superposées, chaque génération ajoute sa vision |
...
La langue elle-même est un artefact multi-générationnel :
- Les **mots portent leur histoire** - L'étymologie reste visible
- La **langue évolue** - Versions successives (proto → ancien → classique)
- **Accumulation de sens** - Les mots se stratifient comme la Fresque
- **Registres temporels** - Mots anciens (sacrés) vs mots récents (quotidiens)
...
| **Pilotis** | Architecture sur l'eau |
...
- Peuple maritime aux cheveux rouges
- Navires = constructions bois (pas créatures)
- Non armés (explorateurs/pêcheurs)
...
- Asymétrie informationnelle recherchée

---

## Comment la culture se reflète dans la langue

| Valeur culturelle | Manifestation linguistique |
|-------------------|---------------------------|
| **Confluence/Union** | Liaison **aa** (mélange) au cœur du système |
| **Observation** | Racine **sili** (regard) omniprésente |
| **Transmission** | 4 niveaux de passé (vécu, regretté, ancestral, mythique) |
| **Hiérarchie sacrée** | Racines sacrées (V-) vs standards (C-) |
| **Vision multi-générationnelle** | Liaisons temporelles (e, ei, ea, eo) |
| **Résolution des conflits** | Liaisons de tension (o) et résolution (oa) |

---

*Document de référence - Civilisation de la Confluence*
*Voir aussi : docs/langue/ pour les règles linguistiques*
